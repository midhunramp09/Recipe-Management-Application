...
export const createRecipe = (recipe) => axios.post(`${BASE_URL}/recipes`, recipe);
export const updateRecipe = (id, updatedRecipe) => axios.put(`${BASE_URL}/recipes/${id}`, updatedRecipe);
